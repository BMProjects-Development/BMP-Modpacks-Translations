...
// trophymanager:trophy[custom_data={BaseBlock:"air",Name:"Super Hoe Trophy",OffsetY:1.0d,Scale:2.0d,TrophyItem:{id:"avaritia:infinity_catalyst"},TrophyType:"item"}]
//   'trophymanager:trophy[custom_data={BaseBlock:"air",Name:"Snock Trophy!",OffsetY:0.25d,Scale:1.5d,TrophyEntity:{entityType:"minecraft:cat", variant:"minecraft:all_black"},TrophyType:"entity"}]'
...
const streamers = {
  ...
  "Threefold":{
    ...
    lines: ["Nice to see you have a break from Greg", "With love from Tazz"],
  },
  "SystemCollapse":{
  ...
  "forestfaerie": {
    ...
    lines: ["Dear Snock!", "Thank you for playing StoneBlock 4!", "With love from Tazz "],
  },
  "ellelapsus":{
    items: ['trophymanager:trophy[custom_data={BaseBlock:"ftbechoes:echo_projector",Name:"Special kind of Trophy",OffsetY:0.6d,Scale:1.0d,TrophyItem:{id:"bhc:red_heart"},TrophyType:"item"}]'],
    lines: ["Just for u :)", "With love <3"],
  },
  "MiyoshiEira":{
  ...
  "twsparklecat": {
    ...
    lines: ["Special Trophy, for Sparkle!", "With love from the FTB Team"],
  },
  "kSunekaer": {
    items: ['trophymanager:trophy[custom_data={BaseBlock:"ftbechoes:echo_projector",Name:"Sunekaer\'s Trophy",OffsetY:0.6d,Scale:1.0d,TrophyItem:{id:"minecraft:cobblestone"},TrophyType:"item"}]'],
    lines: ["Special Trophy, for KSunekaer!", "With love from the FTB Team"],
  },
  "xBCrafted": {
    items: ['trophymanager:trophy[custom_data={BaseBlock:"ftbechoes:echo_projector",Name:"xBCrafted Trophy",OffsetY:0.6d,Scale:1.0d,TrophyItem:{id:"minecraft:diamond_sword"},TrophyType:"item"}]'],
    lines: ["For the release of StoneBlock 4, a Special Trophy, for xBCrafted!", "With love from the FTB Team"],
  },
  "Hypnotizd": {
    items: ['trophymanager:trophy[custom_data={BaseBlock:"ftbechoes:echo_projector",Name:"Hypnotizd Trophy",OffsetY:0.6d,Scale:1.0d,TrophyItem:{id:"minecraft:diamond_chestplate"},TrophyType:"item"}]'],
    lines: ["For the release of StoneBlock 4, a Special Trophy, for Hypnotizd!", "With love from the FTB Team"],
  }
}
