...
ВАЖНОЕ ПРИМЕЧАНИЕ: Большие оптимизированные хранилища, такие как ящики, работают нормально, но большие *не*оптимизированные хранилища с большим количеством слотов, такие как 
колоссальные сундуки, ужасно влияют на производительность при использовании с шинами хранения.
...
разрешая хранить только эти конкретные элементы. У шины много слотов, поэтому ее можно использовать как большой фильтр, если Вы используете её для
переноса предметов.

Предметы можно перетаскивать в слоты из JEI/REI, даже если у вас на самом деле нет ни одного такого предмета.

ПКМ с контейнером для жидкости (например, ведром или баком) установит эту жидкость в качестве фильтра, а не сам контейнер.
